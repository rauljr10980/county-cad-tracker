...
import { LayoutDashboard, List, Upload, FileText, CheckSquare, Home, Car } from 'lucide-react';

export type TabType = 'dashboard' | 'properties' | 'tasks' | 'upload' | 'files' | 'preforeclosure' | 'driving';
