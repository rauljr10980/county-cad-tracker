...
export function ComparisonView() {
  ...
  // DISABLED: Frontend auto-generation to prevent infinite loop
  // Backend already auto-generates during file processing
  // Users can manually click "Generate Comparison" button if needed
  // useEffect(() => {
  ...
  // Refetch when component mounts to check for existing comparison
  useEffect(() => {
