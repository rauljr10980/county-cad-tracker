...
export function ComparisonView() {
  ...
  const handleRegenerateComparison = useCallback(async () => {
    ...
    try {
      ...
      // Set the comparison data in React Query cache
      // This immediately makes it available to the UI without refetching
      ...
      console.log('[COMPARISON] Successfully set comparison data in cache');
